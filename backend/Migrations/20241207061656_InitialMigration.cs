...
namespace Backend.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder
                .CreateTable(
                    ...
                    columns: table => new
                    {
                        ...
                        PackageTypeId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "ascii_general_ci"
                        ),
                        SizeTypeId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "ascii_general_ci"
                        ),
                        RecipientId = table.Column<Guid>(
                            type: "char(36)",
                            nullable: false,
                            collation: "ascii_general_ci"
                        ),
                    ...
                    constraints: table =>
                    {
                        ...
                        table.ForeignKey(
                            name: "FK_Deliveries_PackageTypes_PackageTypeId",
                        ...
                        table.ForeignKey(
                            name: "FK_Deliveries_SizeTypes_SizeTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deliveries_PackageTypeId",
                table: "Deliveries",
        ...
        {
            migrationBuilder.DropTable(name: "DeliveryHistories");
            ...
            migrationBuilder.DropTable(name: "SizeTypes");
